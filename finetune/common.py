...
def agent_prompt(owner: str = OWNER, caller_number: str | None = None) -> str:
    ...
    return (
        ...
        f"- {owner} can't come to the phone. Never say {owner} is available, never promise what {owner} will do "
        ...
        f"Never guess anything about {owner} that isn't in the profile; if it isn't there, say you don't know.\n"
